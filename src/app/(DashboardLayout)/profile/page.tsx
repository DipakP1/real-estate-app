        ...
        <Box className="flexbox">
          <Box className="leftside">
            <Box className="imagecontainer">
              <Image src={"/images/backgrounds/back.jpg"} alt={""} width={50} height={50} className="image" />
            </Box>
            <Box className="name">
            ...
            <Box className="designation">
              ...
              >
                ...
                <DialogContent dividers>
                  <Box className="imagecontainer">
                    <Image src={"/images/backgrounds/back.jpg"} width={150} height={150} alt={""} className="image" />
                  </Box>
                </DialogContent>
