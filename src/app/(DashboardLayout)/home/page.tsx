"use client"
import { Grid, Card, CardContent, Typography, Box, Avatar, Divider, CircularProgress, Stack, Button } from '@mui/material';
    ...
    <Box sx={{ padding: 3 }}>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={7}>
          <Card sx={{ height: '100%', overflow: 'hidden', boxShadow: '0px 2px 5px rgba(0, 0, 0, 0.1)' }}>
            <CardContent sx={{ padding: 0 }}>
              <img src={"/images/backgrounds/dashImg.png"} alt="Ajmera Group" style={{ width: '100%', height: 'auto', display: 'block' }} />
            </CardContent>
